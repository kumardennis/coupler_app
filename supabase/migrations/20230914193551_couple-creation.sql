...
create table "public"."users" (
    ...
    "birthday" date,
    "shareableUuid" uuid default gen_random_uuid()
);
...
alter table "public"."couples" add constraint "couples_initiatedById_fkey" FOREIGN KEY ("initiatedById") REFERENCES users(id) not valid;

alter table "public"."couples" validate constraint "couples_initiatedById_fkey";
